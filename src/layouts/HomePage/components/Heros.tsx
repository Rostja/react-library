          ...
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="ml-2">
              ...
              <p className="lead">
                ...
                Whether it is to learn a skill or grow as a reader, we’ll be
                able to provide recommendations that are relevant to your
                interests.
              </p>
          ...
          >
            <div className="ml-2">
              ...
              <p className="lead">
                ...
                possible for our customers! We are diligent about our book
        ...
        <div className="container">
          <div className="m-2">
            ...
            <div className="mt-2">
              ...
              :
              <Link className="btn main-color btn-lg tex-white" to='/login'>
                Sign up
              </Link>
              }
            </div>
